/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=src/workers/ia-agent/wrangler.jsonc` (hash: 5fc4fcf7f9d3930517ccd00ac0eb60f1)
// Runtime types generated with workerd@1.20260820.1 2026-06-23 nodejs_compat
interface __BaseEnv_Env {
	IA_LLM_BASE_URL: "https://opencode.ai/zen/v1";
	IA_LLM_MODEL: "deepseek-v4-flash-free";
	ENVIRONMENT?: "staging";
	OPENCODE_ZEN_API_KEY: string;
	AGENT: DurableObjectNamespace<import("./src/workers/ia-agent/index").AgentOrchestrator>;
	APP: Service /* entrypoint AppService from synkroo-ia-bridge-staging */ | Service /* entrypoint AppService from synkroo-ia-bridge */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/workers/ia-agent/index");
		durableNamespaces: "AgentOrchestrator";
	}
	interface StagingEnv {
		...
		OPENCODE_ZEN_API_KEY: string;
		AGENT: DurableObjectNamespace<import("./src/workers/ia-agent/index").AgentOrchestrator>;
		APP: Service /* entrypoint AppService from synkroo-ia-bridge-staging */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "IA_LLM_BASE_URL" | "IA_LLM_MODEL" | "ENVIRONMENT" | "OPENCODE_ZEN_API_KEY">> {}
}
