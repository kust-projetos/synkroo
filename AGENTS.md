...
- **CI Production-mode E2E (2026-09-25):** workflow CI vermelho no main desde 2026-09-14 — job 	est:e2e:production falha no seed de fixtures (500 em insert into role_permissions ... on conflict do nothing, constraint unique ausente; e2e/seed-validation.ts:27). Gitleaks destravado 2026-09-25 (binário OSS pinned, wrapper licenciado removido). Follow-up: investigar constraint/schema do seed E2E; não relacionado ao deploy (produção staging/prod com smoke verde).
