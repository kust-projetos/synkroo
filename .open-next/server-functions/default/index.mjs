...
var init_config = __esm({
  "node_modules/@opennextjs/aws/dist/adapters/config/index.js"() {
    ...
    AppPathsManifestKeys = ["/api/activities/route", "/api/admin/run-migration/route", "/api/analytics/metrics/route", "/api/analytics/insights/route", "/api/analytics/noshow-prediction/route", "/api/appointments/[id]/cancel/route", "/api/analytics/roi/route", "/api/appointments/[id]/confirm/route", "/api/appointments/[id]/noshow/route", "/api/appointments/[id]/reactivate/route", "/api/appointments/[id]/remind/route", "/api/appointments/[id]/reminder-template/route", "/api/appointments/[id]/route", "/api/appointments/[id]/reschedule/route", "/api/appointments/availability/route", "/api/appointments/confirm-response/route", "/api/appointments/route", "/api/appointments/incomplete-treatments/route", "/api/auth/[...nextauth]/route", "/api/auth/login/route", "/api/auth/logout/route", "/api/auth/refresh/route", "/api/auth/signup/route", "/api/auth/session/route", "/api/budgets/[id]/accept/route", "/api/budgets/[id]/installments/route", "/api/budgets/[id]/payments/route", "/api/budgets/[id]/reject/route", "/api/budgets/[id]/route", "/api/budgets/[id]/send/route", "/api/budgets/followup/route", "/api/campaigns/[id]/route", "/api/budgets/route", "/api/campaigns/[id]/recipients/route", "/api/campaigns/[id]/start/route", "/api/campaigns/route", "/api/campaigns/process/route", "/api/campaigns/segments/preview/route", "/api/campaigns/segments/route", "/api/consents/route", "/api/contacts/[id]/notes/route", "/api/contacts/[id]/appointments/route", "/api/clinics/settings/route", "/api/contacts/[id]/route", "/api/contacts/route", "/api/contacts/[id]/timeline/route", "/api/conversations/[id]/route", "/api/conversations/route", "/api/crm/stats/route", "/api/cron/cleanup/route", "/api/cron/followups/route", "/api/cron/reminders/route", "/api/cron/smart-triggers/route", "/api/custom-fields/definitions/[id]/route", "/api/custom-fields/definitions/route", "/api/custom-fields/values/route", "/api/dashboard/alerts/route", "/api/dashboard/stats/route", "/api/dentists/[id]/route", "/api/dentists/route", "/api/health/db/route", "/api/health/route", "/api/instagram/webhook/route", "/api/knowledge/[id]/route", "/api/knowledge/categories/route", "/api/knowledge/route", "/api/knowledge/search/route", "/api/leads/[id]/route", "/api/leads/[id]/convert/route", "/api/leads/[id]/stage/route", "/api/leads/hot/route", "/api/leads/kanban/route", "/api/leads/notifications/[id]/acknowledge/route", "/api/leads/notifications/route", "/api/leads/stats/route", "/api/leads/route", "/api/lgpd/anonymize/route", "/api/lgpd/export/route", "/api/messages/inbound/route", "/api/messages/send/route", "/api/messages/history/[conversationId]/route", "/api/messages/whatsapp/route", "/api/patients/[id]/history/route", "/api/patients/[id]/preferences/route", "/api/patients/[id]/observations/route", "/api/patients/[id]/route", "/api/patients/inactive/route", "/api/patients/deduplicate/route", "/api/patients/tags/route", "/api/patients/route", "/api/pipeline/analytics/route", "/api/pipeline/stages/[id]/route", "/api/pipeline/stages/route", "/api/pipeline/stages/reorder/route", "/api/procedures/[id]/route", "/api/procedures/route", "/api/reports/export/route", "/api/reminders/config/route", "/api/reports/financial/route", "/api/tasks/route", "/api/reports/patients/route", "/api/seed/route", "/api/treatment-plans/[id]/sessions/route", "/api/treatment-plans/[id]/route", "/api/waitlist/route", "/api/treatment-plans/route", "/api/whatsapp/evolution/route", "/api/whatsapp/qrcode/route", "/api/whatsapp/templates/route", "/api/whatsapp/send/route", "/api/whatsapp/webhook/route", "/api/widget/messages/route", "/_not-found", "/login", "/", "/signup", "/dashboard/agendamentos/[id]", "/dashboard/agendamentos", "/dashboard/agendamentos/novo", "/dashboard/atividades", "/dashboard/campanhas/[id]", "/dashboard/campanhas/nova", "/dashboard/analytics", "/dashboard/campanhas", "/dashboard/configuracao", "/dashboard/contatos", "/dashboard/crm", "/dashboard/configuracoes", "/dashboard/conversas", "/dashboard/crm/pipeline", "/dashboard/dentistas", "/dashboard/dentistas/novo", "/dashboard/dentistas/[id]", "/dashboard/leads/[id]", "/dashboard/leads/novo", "/dashboard/lista-espera", "/dashboard/pacientes/[id]/editar", "/dashboard/leads", "/dashboard/pacientes/inativos", "/dashboard/pacientes/novo", "/dashboard/pacientes", "/dashboard/pacientes/[id]", "/dashboard", "/dashboard/procedimentos/novo", "/dashboard/procedimentos/[id]", "/dashboard/procedimentos", "/dashboard/pipeline", "/dashboard/configuracoes/acessos/perfis", "/dashboard/tarefas", "/dashboard/configuracoes/acessos"];
