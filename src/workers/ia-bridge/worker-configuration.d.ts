/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.ia-bridge.jsonc src/workers/ia-bridge/worker-configuration.d.ts` (hash: f69d10472fe795496a2f6b3f08323cb3)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DATABASE_URL" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE" | "HANDLE_SECRET" | "AUTH_SECRET" | "JWT_SECRET" | "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_ANON_KEY" | "SUPABASE_SERVICE_ROLE_KEY" | "GH_TOKEN" | "GITHUB_TOKEN" | "GH_ORG_TOKEN" | "GITHUB_ORG_TOKEN" | "NEXTAUTH_URL" | "SEED_SECRET" | "NEXT_PUBLIC_USE_MOCKS" | "OPENCODE_ZEN_API_KEY" | "IA_LLM_MODEL" | "IA_LLM_BASE_URL">> {}
}
