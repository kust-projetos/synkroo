/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=src/workers/ia-agent/wrangler.jsonc src/workers/ia-agent/worker-configuration.d.ts` (hash: 29bb8a67cea1d0fb4beef1c76b1792ee)
// Runtime types generated with workerd@1.20260616.1 2026-06-23 nodejs_compat
interface __BaseEnv_Env {
	...
	APP: Service /* entrypoint AppService from synkroo-ia-bridge */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "IA_LLM_BASE_URL" | "IA_LLM_MODEL">> {}
}
