...
export const leads = pgTable(
  ...
  (t) => ({
    clinicPhoneNormalizedUniq: uniqueIndex("leads_clinic_phone_normalized_uniq")
      .on(t.clinicId, t.phoneNormalized)
      .where(
        sql`${t.phoneNormalized} IS NOT NULL AND ${t.phoneNormalized} <> ''`,
      ),
  }),
);
