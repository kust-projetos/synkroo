...
DO $$BEGIN
  IF NOT EXISTS (
    ...
    AND conname = 'crm_duplicate_suggestions_winner_member_check'
  ) THEN
...
-- Rollback:
--   ALTER TABLE crm_duplicate_suggestions DROP CONSTRAINT crm_duplicate_suggestions_winner_member_check;
