/**
 * Test MiniMax API Connection - Corrected
 * Run: node scripts/test-minimax-fixed.js
 */
...
console.log('🔍 Testing MiniMax API Connection (Corrected)...\n');
...
async function runTests() {
  try {
    ...
    console.log('\n❌ Some tests failed. Error:', error.message);
  }
}
