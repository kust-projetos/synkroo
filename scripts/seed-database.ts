...
const PROCEDURE_SEED: readonly {
  ...
  { name: 'Limpeza (Profilaxia)', description: 'Limpeza profissional dos dentes com remocao de tartaro e placas', duration_minutes: 30, price: 150, category: 'Preventiva' },
  { name: 'Obturacao (Restauracao)', description: 'Restauracao de dente cariado com material composto', duration_minutes: 45, price: 200, category: 'Restauradora' },
  { name: 'Tratamento de Canal', description: 'Tratamento endodontico completo do canal radicular', duration_minutes: 60, price: 500, category: 'Endodontia' },
  { name: 'Extracao Simples', description: 'Extracao de dente sem complexidade cirurgica', duration_minutes: 30, price: 180, category: 'Cirurgica' },
  { name: 'Extracao Siso', description: 'Extracao de dente do siso (terceiro molar)', duration_minutes: 60, price: 400, category: 'Cirurgica' },
  { name: 'Clareamento Dental', description: 'Clareamento profissional dos dentes em consultorio', duration_minutes: 45, price: 800, category: 'Estetica' },
  { name: 'Avaliacao Ortodontica', description: 'Avaliacao inicial para tratamento ortodontico com aparelho', duration_minutes: 30, price: 300, category: 'Ortodontia' },
  { name: 'Manutencao de Aparelho', description: 'Ajuste e manutencao periodica de aparelho ortodontico', duration_minutes: 30, price: 150, category: 'Ortodontia' },
  { name: 'Consulta Implante', description: 'Avaliacao para colocacao de implante dentario', duration_minutes: 45, price: 350, category: 'Implantodontia' },
  { name: 'Coroa Provisoria', description: 'Colocacao de coroa provisoria em dente preparado', duration_minutes: 45, price: 400, category: 'Restauradora' },
  { name: 'Raio-X Panoramico', description: 'Exame radiografico panoramico completo da arcada dentaria', duration_minutes: 15, price: 80, category: 'Diagnostica' },
  { name: 'Consulta de Retorno', description: 'Consulta de retorno pos-procedimento para acompanhamento', duration_minutes: 15, price: 0, category: 'Consulta' },
]
...
const PATIENT_SEED: readonly {
  ...
  { name: 'Luciana Ferreira', gender: 'F', email: 'luciana.ferreira@email.com', notes: 'Alérégica a latex' },
  { name: 'Roberto Almeida', gender: 'M', email: 'roberto.almeida@email.com' },
  { name: 'Fernanda Costa', gender: 'F', email: 'fernanda.costa@email.com', notes: 'Paciente ansiosa — agendar com calma' },
  { name: 'Carlos Eduardo Souza', gender: 'M' },
  { name: 'Patricia Rocha', gender: 'F', email: 'patricia.rocha@email.com' },
  { name: 'Marcos Vinicius Lima', gender: 'M' },
  { name: 'Juliana Martins', gender: 'F', email: 'juliana.martins@email.com', notes: 'Prefere consultas pela manha' },
  { name: 'Andrei Barbosa', gender: 'M' },
  { name: 'Camila Rodrigues', gender: 'F' },
  { name: 'Bruno Gomes', gender: 'M', email: 'bruno.gomes@email.com' },
  { name: 'Isabela Nascimento', gender: 'F' },
  { name: 'Thiago Ribeiro', gender: 'M', notes: 'Hipertenso — verificar medicacao' },
  { name: 'Amanda Lopes', gender: 'F', email: 'amanda.lopes@email.com' },
  { name: 'Rafael Carvalho', gender: 'M' },
  { name: 'Beatriz Mendes', gender: 'F' },
  { name: 'Lucas Araujo', gender: 'M', email: 'lucas.araujo@email.com' },
  { name: 'Gabriela Santos', gender: 'F', notes: 'Gestante — 2o trimestre' },
  { name: 'Diego Fernandes', gender: 'M' },
  { name: 'Mariana Dias', gender: 'F', email: 'mariana.dias@email.com' },
  { name: 'Felipe Moreira', gender: 'M' },
  { name: 'Daniela Correia', gender: 'F' },
  { name: 'Gustavo Nunes', gender: 'M', email: 'gustavo.nunes@email.com', notes: 'Paciente novo — indicação da Dra. Maria' },
  { name: 'Tatiana Vieira', gender: 'F' },
  { name: 'Leonardo Pinto', gender: 'M' },
  { name: 'Carolina Monteiro', gender: 'F', email: 'carolina.monteiro@email.com' },
  { name: 'Ricardo Batista', gender: 'M' },
  { name: 'Priscila Teixeira', gender: 'F', notes: 'Diabetica tipo 2' },
  { name: 'Henrique Moura', gender: 'M', email: 'henrique.moura@email.com' },
