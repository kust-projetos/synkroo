...
const PATIENT_SEED = [
  { name: 'Paciente Demo 01', gender: 'F', email: 'paciente01@example.com', notes: '[demo] consulta de rotina' },
  { name: 'Paciente Demo 02', gender: 'M', email: 'paciente02@example.com' },
  { name: 'Paciente Demo 03', gender: 'F', email: 'paciente03@example.com', notes: '[demo] retorno agendado' },
  { name: 'Paciente Demo 04', gender: 'M' },
  { name: 'Paciente Demo 05', gender: 'F', email: 'paciente05@example.com' },
  { name: 'Paciente Demo 06', gender: 'M' },
  { name: 'Paciente Demo 07', gender: 'F', email: 'paciente07@example.com', notes: '[demo] consulta de rotina' },
  { name: 'Paciente Demo 08', gender: 'M' },
  { name: 'Paciente Demo 09', gender: 'F' },
  { name: 'Paciente Demo 10', gender: 'M', email: 'paciente10@example.com' },
  { name: 'Paciente Demo 11', gender: 'F' },
  { name: 'Paciente Demo 12', gender: 'M', notes: '[demo] retorno agendado' },
  { name: 'Paciente Demo 13', gender: 'F', email: 'paciente13@example.com' },
  { name: 'Paciente Demo 14', gender: 'M' },
  { name: 'Paciente Demo 15', gender: 'F' },
  { name: 'Paciente Demo 16', gender: 'M', email: 'paciente16@example.com' },
  { name: 'Paciente Demo 17', gender: 'F', notes: '[demo] consulta de rotina' },
  { name: 'Paciente Demo 18', gender: 'M' },
  { name: 'Paciente Demo 19', gender: 'F', email: 'paciente19@example.com' },
  { name: 'Paciente Demo 20', gender: 'M' },
] as const
