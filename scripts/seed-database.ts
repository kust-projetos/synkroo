...
const DENTIST_SEED = [
  { name: 'Dr. Maria Silva', phone: '(11) 99999-0001', email: 'maria.silva@odontodemo.com.br', cro: 'CRO-SP 12345', specialty: 'Ortodontia' },
  { name: 'Dr. Joao Santos', phone: '(11) 99999-0002', email: 'joao.santos@odontodemo.com.br', cro: 'CRO-SP 54321', specialty: 'Implantodontia' },
  { name: 'Dr. Ana Oliveira', phone: '(11) 99999-0003', email: 'ana.oliveira@odontodemo.com.br', cro: 'CRO-SP 67890', specialty: 'Endodontia' },
  { name: 'Dr. Carlos Pereira', phone: '(11) 99999-0004', email: 'carlos.pereira@odontodemo.com.br', cro: 'CRO-SP 11111', specialty: 'Clinico Geral' },
] as const
...
const PROCEDURE_SEED = [
  { name: 'Limpeza (Profilaxia)', description: 'Limpeza profissional dos dentes', durationMinutes: 30, price: 150, category: 'Preventiva' },
  { name: 'Obturacao (Restauracao)', description: 'Restauracao de dente cariado', durationMinutes: 45, price: 200, category: 'Restauradora' },
  { name: 'Tratamento de Canal', description: 'Tratamento endodontico completo', durationMinutes: 60, price: 500, category: 'Endodontia' },
  { name: 'Extracao Simples', description: 'Extracao de dente sem complexidade', durationMinutes: 30, price: 180, category: 'Cirurgica' },
  { name: 'Extracao Siso', description: 'Extracao de dente do siso', durationMinutes: 60, price: 400, category: 'Cirurgica' },
  { name: 'Clareamento Dental', description: 'Clareamento profissional', durationMinutes: 45, price: 800, category: 'Estetica' },
  { name: 'Avaliacao Ortodontica', description: 'Avaliacao inicial ortodontica', durationMinutes: 30, price: 300, category: 'Ortodontia' },
  { name: 'Manutencao de Aparelho', description: 'Ajuste periodico de aparelho', durationMinutes: 30, price: 150, category: 'Ortodontia' },
  { name: 'Consulta Implante', description: 'Avaliacao para implante', durationMinutes: 45, price: 350, category: 'Implantodontia' },
  { name: 'Coroa Provisoria', description: 'Colocacao de coroa provisoria', durationMinutes: 45, price: 400, category: 'Restauradora' },
  { name: 'Raio-X Panoramico', description: 'Exame radiografico panoramico', durationMinutes: 15, price: 80, category: 'Diagnostica' },
  { name: 'Consulta de Retorno', description: 'Consulta de retorno pos-procedimento', durationMinutes: 15, price: 0, category: 'Consulta' },
] as const
...
const PATIENT_SEED = [
  { name: 'Luciana Ferreira', gender: 'F', email: 'luciana.ferreira@email.com', notes: 'Alergica a latex' },
  { name: 'Roberto Almeida', gender: 'M', email: 'roberto.almeida@email.com' },
  { name: 'Fernanda Costa', gender: 'F', email: 'fernanda.costa@email.com', notes: 'Paciente ansiosa' },
  ...
  { name: 'Juliana Martins', gender: 'F', email: 'juliana.martins@email.com', notes: 'Prefere manha' },
  ...
  { name: 'Thiago Ribeiro', gender: 'M', notes: 'Hipertenso' },
  ...
  { name: 'Gabriela Santos', gender: 'F', notes: 'Gestante' },
