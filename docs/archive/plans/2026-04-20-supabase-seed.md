...
async function seedDentists(supabase: ReturnType<typeof createClient>, clinicId: string): Promise<string[]> {
  const DENTISTS = [
    { name: 'Registro Demo 24', specialty: 'Ortodontia', phone: '(11) 99999-0001', email: 'maria@odontodemo.com.br', cro: 'CRO-SP 12345' },
    { name: 'Registro Demo 23', specialty: 'Implantodontia', phone: '(11) 99999-0002', email: 'joao@odontodemo.com.br', cro: 'CRO-SP 54321' },
    { name: 'Registro Demo 21', specialty: 'Endodontia', phone: '(11) 99999-0003', email: 'ana@odontodemo.com.br', cro: 'CRO-SP 67890' },
    { name: 'Registro Demo 22', specialty: 'Clinico Geral', phone: '(11) 99999-0004', email: 'carlos@odontodemo.com.br', cro: 'CRO-SP 11111' },
  ]
...
async function seedProcedures(supabase: ReturnType<typeof createClient>, clinicId: string): Promise<string[]> {
  const PROCEDURES = [
    { name: 'Registro Demo 42', duration_minutes: 30, price: 150.00, category: 'Preventiva', description: 'Limpeza profissional e profilaxia dental' },
    { name: 'Registro Demo 51', duration_minutes: 45, price: 200.00, category: 'Restauradora', description: 'Restauracao com material composto' },
    { name: 'Registro Demo 63', duration_minutes: 60, price: 500.00, category: 'Endodontia', description: 'Tratamento endodontico completo' },
    { name: 'Registro Demo 26', duration_minutes: 30, price: 180.00, category: 'Cirurgica', description: 'Extracao dental simples' },
    { name: 'Registro Demo 27', duration_minutes: 60, price: 400.00, category: 'Cirurgica', description: 'Extracao de dente siso' },
    { name: 'Registro Demo 14', duration_minutes: 45, price: 800.00, category: 'Estetica', description: 'Clareamento profissional' },
    { name: 'Registro Demo 6', duration_minutes: 30, price: 300.00, category: 'Ortodontia', description: 'Consulta inicial para aparelho' },
    { name: 'Registro Demo 45', duration_minutes: 30, price: 150.00, category: 'Ortodontia', description: 'Ajuste e manutencao de aparelho' },
    { name: 'Registro Demo 17', duration_minutes: 45, price: 350.00, category: 'Implantodontia', description: 'Avaliacao para implante dentario' },
    { name: 'Registro Demo 18', duration_minutes: 45, price: 400.00, category: 'Restauradora', description: 'Colocacao de coroa provisoria' },
    { name: 'Registro Demo 56', duration_minutes: 15, price: 80.00, category: 'Diagnostica', description: 'Raio-X panoramico completo' },
    { name: 'Registro Demo 16', duration_minutes: 15, price: 0.00, category: 'Consulta', description: 'Consulta de retorno pos-procedimento' },
  ]
...
async function seedPatients(supabase: ReturnType<typeof createClient>, clinicId: string): Promise<string[]> {
  ...
  const inserts = PATIENT_NAMES.map((name, i) => {
    ...
    const email = hasEmail ? `${firstName}@example.com` : undefined
    // Some have notes
