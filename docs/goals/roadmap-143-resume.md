...
- `npx wrangler deploy --env staging --config wrangler.toml` **DEPLOYED 2026-08-26T20:36:11Z** `https://synkroo-staging.walissonead.workers.dev` `Version 8ab87ce8-d7d3-481b-a393-614650582e54` + `wrangler.ia-bridge.jsonc --env staging` `b40a81ac-2b93-4556-9024-6b213b3bdd33` `https://synkroo-ia-bridge-staging` + `ia-agent/wrangler.jsonc --env staging` `ee88f1a2-7c4e-464b-ae53-0ae414d2bd8d` `https://synkroo-ia-agent-staging`; `wrangler whoami` `owner (contato privado)` `1396fe3fb16f79f1ea131f8502730fac` OAuth `workers:write` OK
...
1. `git status --short` `M src/middleware.ts` + `node scripts/roadmap-ledger.mjs --check` `143/126` + `gh run list --workflow="CI"` `33009233388 success b5d04872` + `33007810627 success a8244aeb` + `npx wrangler whoami` `owner (contato privado)`
