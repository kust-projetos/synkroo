...
| F2.03–F2.08 | PARTIAL | `f2-03-f2-08-core-actions.md`, `f2-isolated-integration.md`, `f2-core-actions-integration.md`, `f2-webhook-gates-integration.md` | Core/webhook DB suites PASS; broader cross-domain race suites remain |
...
| F2.15 | VERIFIED | `f2-15-public-routes.md`, `f2-webhook-gates-integration.md` | Provider/runtime smoke externo não executado |
| F2.16 | VERIFIED | `f2-16-csrf-origin.md`, `f2-webhook-gates-integration.md` | Matrix cobre middleware custom auth |
