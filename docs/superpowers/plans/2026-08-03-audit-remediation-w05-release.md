...
- [x] **Step 1: consultar documentação atual**
...
- [x] **Step 2: escrever teste RED de bindings/config**
...
- [x] **Step 3: reconciliar código, bindings e migrations DO**
...
- [x] **Step 4: regenerar types e executar testes**
...
- [x] **Step 1: limpar artefatos sem tocar source**

```bash
rm -rf .next .open-next
```

- [x] **Step 2: executar build em WSL**
...
- [x] **Step 3: validar dry-run e startup**
...
- [x] **Step 4: commit somente runbook**
...
- [x] **Step 1: definir environment sem IDs ou secrets fictícios**
...
- [x] **Step 2: validar autenticação e secrets por nome**
...
- [x] **Step 3: dry-run do environment**
...
- [x] **Step 1: escrever RED do catálogo PostgreSQL**
...
- [x] **Step 2: restaurar backup anonimizado em banco de staging**
...
- [x] **Step 3: ensaiar rollback de Worker**
...
- [x] **Step 1: escrever teste RED do runner**
...
- [x] **Step 2: implementar checks com timeout**
...
- [x] **Step 3: executar contra staging**
...
- [x] **Step 1: obter aprovação explícita do owner antes de mutação remota**
...
- [x] **Step 3: smoke e observabilidade**
...
- [x] **Step 4: rollback e novo smoke**
...
- [x] **Step 5: registrar evidência e commit**
...
- [x] **Step 1: executar gates finais frescos**
...
- [x] **Step 2: executar quatro reviews independentes**
...
- [x] **Step 4: registrar decisão, evidências e commit**
...
W5 release evidence is recorded in docs/superpowers/audits/2026-08-13-final-gate-results.json and the historical ledger; current candidate Cloudflare evidence is linked by the 2026-08-14 gate record.
